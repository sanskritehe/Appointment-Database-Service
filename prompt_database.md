...
## Role: Database Layer
You are implementing ONLY the database layer for this service.
Generate ONLY:
- SQLAlchemy models (models.py)
- Database CRUD functions (crud.py or db/)
- Alembic migrations if needed
- FastAPI route handlers that directly serve the database (this IS the database service)

Do NOT generate: external HTTP client calls — this IS the database service.
